...
#    Updated: 2017/11/08 10:21:40 by ncella           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES = ft_memset.c ft_strcpy.c ft_strdup.c ft_strlen.c ft_bzero.c \
		...
		ft_cpy.c ft_strsplit_1.c

OBJECT = ft_memset.o ft_strcpy.o ft_strdup.o ft_strlen.o ft_bzero.o \
		ft_memcpy.o ft_memccpy.o ft_memmove.o ft_memchr.o ft_memcmp.o \
		ft_isprint.o ft_isascii.o ft_isalnum.o ft_isdigit.o ft_isalpha.o \
		ft_strncpy.o ft_strcat.o ft_strncat.o ft_strstr.o ft_strncmp.o \
		ft_atoi.o ft_strcmp.o ft_toupper.o ft_tolower.o ft_strchr.o  \
		...
		ft_putstr_fd.o ft_putendl_fd.o ft_putnbr_fd.o ft_strnstr.o \
		ft_itoa.o ft_strsplit.o ft_strlcat.o ft_lstnew.o ft_lstdelone.o \
		ft_lstdel.o ft_lstadd.o ft_lstiter.o ft_lstmap.o ft_counter_atoi.o \
		ft_len_int.o ft_while_itoa.o ft_nb_words.o ft_length_words.o \
		ft_cpy.o ft_strsplit_1.o
